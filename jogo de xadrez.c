...
int main(){
int i = 1; 
int j = 1; // Inicializa a variável j com 1 p/ rainha     // Inicializa a variável i com 1 p/ bispo
int movimentoCavalo = 1; // para movimento do cavalo em L.
...
while (i <= 5) { // Enquanto i for menor ou igual a 5, o loop continua
    ...
    do {
        ...
        while (movimentoCavalo--)
        {
            for (int i = 0; i < 2; i++)
            {
                printf("Cavalo para Baixo\n"); // imprime a direcao do movimento do cavalo
            }
